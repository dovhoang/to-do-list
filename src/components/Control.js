    ...
    return (
      <div className="row">
        <div className="col-md-4">
          <div className="input-group mb-3">
            ...
            <div className="input-group-append">
              <button onClick={this.handleSearch} className="btn btn-success" type="button" id="button-addon2">Search</button>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6">
          <button onClick={this.handleSubmitAddTag} type="button" className="btn btn-primary btn-block" data-toggle="button" aria-pressed="false" autoComplete="off">Add Tag</button>
        </div>
      </div>
    );
  };
